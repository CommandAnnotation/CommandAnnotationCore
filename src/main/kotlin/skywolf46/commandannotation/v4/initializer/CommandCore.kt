...
object CommandCore {
    ...
    @AddonDevelopmentMethod
    fun registerArgumentGenerator(method: MethodWrapper) {
        val returnType = method.method.returnType
        ...
        val invoker = MethodInvoker(method)
        registerArgumentGenerator(returnType.kotlin as KClass<Any>, ArgumentGeneratorWrapper {
            return@ArgumentGeneratorWrapper invoker.invoke(this) as Arguments?
    ...
    @AddonDevelopmentMethod
    fun <T : Any> registerArgumentGenerator(cls: KClass<T>, generator: ArgumentGeneratorWrapper) {
        this.argumentGenerator[cls] = generator
    }

    @AddonDevelopmentMethod
    fun <T : Any> registerArgumentGenerator(cls: Class<T>, generator: ArgumentGeneratorWrapper) {
